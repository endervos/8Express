// WritePost.jsx - Component cho người dùng viết bài
...
const WritePost = ({ isLoggedIn, userInfo }) => {
  const navigate = useNavigate(); // ← SỬA: dùng navigate thay vì Navigate
