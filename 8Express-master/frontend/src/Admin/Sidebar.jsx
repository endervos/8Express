...
const Sidebar = ({ activeTab, setActiveTab, onLogout, onGoHome }) => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-gray-900 text-white">
      ...
      <button
        onClick={onLogout}
        className="absolute bottom-6 left-6 right-6 flex items-center justify-center gap-2 px-4 py-3 bg-red-600 hover:bg-red-700 rounded-lg transition font-medium"
      >
        <LogOut size={20} />
        <span>Đăng xuất</span>
      </button>
