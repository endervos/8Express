...
module.exports = {
  async up(q, S) {
    ...
    await q.addConstraint("Share", {
      fields: ["post_id"], type: "foreign key", name: "fk_share_post",
      references: { table: "Post", field: "id" }, onDelete: "CASCADE", onUpdate: "CASCADE"
    });
    await q.addConstraint("Share", {
      fields: ["shared_by"], type: "foreign key", name: "fk_share_user",
  ...
  async down(q) { await q.dropTable("Share"); }
};